      ...
      <Navbar collapseOnSelect expand="lg" className="bg-transparent">
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          ...
          <Nav className="ml-auto">
            <Nav.Link href="/home_ko"> Home </Nav.Link>
            <Nav.Link href="/Community_Resources_ko"> Community Resources  </Nav.Link>
            <Nav.Link href="/Dementia_Information_ko">Dementia Information </Nav.Link>
            <Nav.Link href="/Research_ko">            Research             </Nav.Link>
            <Nav.Link href="/Outreach_ko">            Outreach             </Nav.Link>
            <Nav.Link href="/contact_us_ko">          Contact Us           </Nav.Link>
            <Nav.Link href="/about_us_ko">            About Us           </Nav.Link>
          </Nav> 
